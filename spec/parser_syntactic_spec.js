...
describe("Program Syntactic testing of VpfParser", function(){
	...
	it("can read latlng with negative decimal coordinates", function(){
		let input = ["latlng", "-48.857735;-2.394987"];
		let result = this.analyzer.latlng(input);
		expect(result).toEqual({ lat: "-48.857735", lng: "-2.394987" });
	});
